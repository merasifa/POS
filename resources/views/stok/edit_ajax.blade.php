            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $stok->supplier->supplier_nama }}" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               required
                               min="{{ $stok->stok_jumlah }}"
                               data-jumlah-lama="{{ $stok->stok_jumlah }}">
        ...
        $(document).ready(function () {
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    const jumlahLama = parseInt($("#stok_jumlah").data("jumlah-lama"));
                    const jumlahBaru = parseInt($("#stok_jumlah").val());

                    if (jumlahBaru < jumlahLama) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Tidak Diizinkan',
                            text: 'Jumlah stok tidak boleh dikurangi.'
                        });
                        return false;
                    }
